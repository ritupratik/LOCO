...
async def on_member_join(member):
    ...
    await client.send_message(member, 'Hello Guys...Welcome in TRivia Crack Thankyou for joining...If u want trivia answers from this group type-"₹help please use ₹ sign before every command"')
